...
struct LabView: View {
                ...
                .fill(
                    LinearGradient(
                        colors: [
                            ...
                            Color(red: 0.76, green: 0.86, blue: 0.96)
                        ],
    ...
    private func infoCard(icon: String, iconColor: Color, iconBackground: Color, title: String) -> some View {
        HStack(spacing: 14) {
            Circle()
                .fill(iconBackground)
                .frame(width: 44, height: 44)
