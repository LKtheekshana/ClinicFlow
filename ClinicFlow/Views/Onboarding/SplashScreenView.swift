                    ...
                    VStack(spacing: 0) {
                        ...
                        ZStack {
                            ...
                            Image(systemName: "cross.case.fill")
                                .scalableFont(size: 38, weight: .medium)
                        ...
                        // App name
                        Text("CareConnect")
                            .scalableFont(size: 34, weight: .bold, design: .rounded)
                            .foregroundStyle(.white)
                            .tracking(0.4)
                            .padding(.top, 24)
                            .opacity(textOpacity)
                        ...
                        Text("Your Health, Our Priority")
                            .scalableFont(size: 15, weight: .regular, design: .rounded)
                        ...
                        VStack(spacing: 10) {
                            ...
                            Text("Loading…")
                                .scalableFont(size: 12, weight: .medium, design: .rounded)
